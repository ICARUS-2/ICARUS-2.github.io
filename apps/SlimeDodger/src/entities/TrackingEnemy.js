...
export default class TrackingEnemy extends GameEntity{
    ...
    update(dt){
        ...
        let verticalDiff = Math.abs(this.level.player.hitbox.position.y - this.hitbox.position.y);
        let horizontalDiff = Math.abs(this.level.player.hitbox.position.x - this.hitbox.position.x);

        if (verticalDiff > horizontalDiff){
            if (this.level.player.hitbox.position.y > this.hitbox.position.y){
            ...
            if (this.level.player.hitbox.position.x > this.hitbox.position.x){
